...
const logos = [
  {
    name: 'Implantaly',
    url: '/partners/logo-Implantaly.png',
  },
  {
    name: 'MCC',
    url: '/partners/logo-mcc.png',
  },
  {
    name: 'idesign',
    url: '/partners/logo-idesign.png',
  },
]
  ...
  return (
    <div className="w-full py-12">
      <div className="mx-auto w-full px-4 md:px-8">
        <div
          className="group relative mt-6 flex items-center gap-6 overflow-hidden p-2"
          style={{
            maskImage:
              ...
              >
                {logos.map((logo, key) => (
                  <img
                    key={key}
                    src={logo.url}
                    className="h-18 w-auto max-w-[14rem] px-2 object-contain brightness-0 dark:invert"
                    alt={`${logo.name}`}
                  />
                ))}
              </div>
